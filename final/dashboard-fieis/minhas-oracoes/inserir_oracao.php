...
$titulo = addslashes($_POST['titulo_novo']);
$descricao = addslashes($_POST['desc_novo']);
$categorias1 = addslashes($_POST['cat1_novo']);
$categorias2 = addslashes($_POST['cat2_novo']);
$categorias3 = addslashes($_POST['cat3_novo']);
$categorias4 = addslashes($_POST['cat4_novo']);
