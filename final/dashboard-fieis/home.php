                        ...
                        <?php
                            ...
                            if (count($res_p) > 0) {
                                ...
                                ?>
                                    ...
                                    <button onclick="sairdojejum(<?=$id_jejum?>)" name="btnbtn-sair-do-jejum<?=$id_jejum?>" id="btnbtn-sair-do-jejum<?=$id_jejum?>" class="btn btn-warning">Cancelar Participação</button>
                                <?php
                            }
                        ?>
